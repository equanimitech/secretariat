...
- **Grammar** — "trying to Teste real" parses as "trying to [headline]" which is broken. The headline is a noun, not a verb. Need a verb in the template: "*Stamp* «Teste real»" or "*Sign* «Teste real»".
