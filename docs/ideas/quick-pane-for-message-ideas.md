...
- This is the *capture* end of the scribe-background-journaling idea (`docs/ideas/scribe-background-journaling.md`) but principal-initiated rather than scribe-initiated. Manual capture is simpler to ship; scribe-auto-capture lands later when the cognition ports are richer.
