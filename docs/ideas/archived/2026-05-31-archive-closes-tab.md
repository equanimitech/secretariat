...
Archiving a doc/envelope should also close its open tab and remove it from the channel timeline view. Small UX correctness fix — archive currently leaves stale surfaces.
