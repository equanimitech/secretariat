...
Editorial-typography pass on the markdown editor: font sizing scale, em-dash rendering, general polish toward the Claude reading surface. Cosmetic but affects daily-use feel.
