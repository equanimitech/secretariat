...
- But: a "native" AI panel inside Secretariat would let the principal compose without leaving the app. They'd talk to Claude _inside_ the review window, draft an envelope, see it land in the queue, stamp it.
