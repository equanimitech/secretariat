...
- **Leaving items in place is a valid outcome.** A draft you don't stamp now stays in the queue's `envelopes/` tree (its `delivered:` frontmatter field absent) and re-surfaces next session. That's the lightweight "remind me later" today.
